...
TEST_DATABASE_URL="postgresql://postgres:integration-password@127.0.0.1:${PORT}/alternative_scoring" \
  ...
  tests/integration/evaluations/scoring-failures.test.ts \
  tests/integration/evaluations/retry-and-reconcile.test.ts

echo "US2 PostgreSQL failures, retry, correction and reconciliation: PASS"
