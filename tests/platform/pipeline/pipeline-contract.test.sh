...
const order = ['inspect', 'test', 'secure', 'build-frontend', 'build-ingestion', 'build-scoring', 'build-terms-web', 'build-terms-api', 'render', 'publish', 'promote', 'verify'];
...
for (const result of ['frontend-digest', 'ingestion-digest', 'scoring-digest', 'terms-web-digest', 'terms-api-digest', 'evidence-ref']) {
